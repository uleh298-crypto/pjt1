            ...
            ScrollView {
                VStack(spacing: 0) {
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        Text("이 약관은 2024년 5월 30일에 개정되었습니다.")
                            .font(.system(size: 13))
...
제1조(목적) 싸브리타임 서비스 이용약관은 삼성 SW·AI 교육센터와 함께하는 프로젝트를 통해 제작된 싸브리타임 서비스(이하 "서비스"라 합니다)의 이용과 관련하여 서비스 운영진(이하 "운영진"이라 합니다)과 싸용자 간의 권리, 의무 및 책임 사항 등을 규정함을 목적으로 합니다.
...
1. 이용자가 이 약관 및 커뮤니티 이용규칙에서 이 조항 적용이 명시된 금지행위 및 이에 준하는 행위를 할 경우, 회사는 서비스 보호를 위해 다음과 같은 조치를 최대 영구적으로 취할 수 있습니다.
